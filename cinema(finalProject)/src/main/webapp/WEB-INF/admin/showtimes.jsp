...
<body>
            ...
            <div class="card-bg-color  mb-5 mb-lg-0">
                <div class="card-body inner-bg">
                    ...
                    <div class="table-container">
                        ...
                        <form id="session-create" action="${pageContext.request.contextPath}/films/addsession?${pageContext.request.queryString}" method="post">
                            <div>
                                <div class="movie-row">
                                    <div class="form-group">
    ...
    <div id="sure-span" class="sure-span" style="display:none">
        ...
        <div class="order-bottom">
            <button class="btn btn-danger" onclick="post('/remsession', {sessionId : document.getElementById('id-session-holder').innerText}, 'post')">
