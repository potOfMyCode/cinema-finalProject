    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mybutton">
                    <a class="nav-link" href="${pageContext.request.contextPath}/films/tickets">
                        <fmt:message key="mytickets"/>
                    </a>
                </li>
                ...
                <li class="nav-item mybutton">
                    <span class="btn nav-link rounded singup" style="background: #ffc107; color: black;"><jsp:getProperty name="user" property="username"/></span>
                </li>
            </ul>
        </div>
    </div>
